# eb8's custom VanillaOS Images
This Repo is as basic source repo for my customizations of the VanillaOS/KDE/Plasma (Kanola-Images) images
It does creata a base-image. vos-eb8-base
